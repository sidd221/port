        ...
        <div className="flex justify-between items-center">
          <div className="flex-shrink-0 flex items-center">
            <a href="#home" className="flex items-center gap-2 text-2xl font-display font-bold text-gradient">
              <img src="/my-logo.png" alt="Logo" className="h-8 w-auto object-contain" />
              Siddhant Sinha
            </a>
          </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="md:hidden absolute top-full left-0 w-full glass border-t border-slate-200 dark:border-white/10"
          >
