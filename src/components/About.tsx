        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              >
                <div className="glass h-full p-6 text-left rounded-3xl border border-slate-200 dark:border-white/5 hover:-translate-y-2 hover:shadow-2xl hover:z-10 transition-all duration-300 ease-out group relative overflow-hidden">
